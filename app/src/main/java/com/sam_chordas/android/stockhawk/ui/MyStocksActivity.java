...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String weekBeforeDate = lastWeek.toString().substring(0, lastWeek.toString().indexOf('T'));
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        detailActivityIntent.putExtra("currentDate",nowDate);
                        detailActivityIntent.putExtra("weekBefore",weekBeforeDate);
                    ...
                    new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                                ...
                                public void onInput(MaterialDialog dialog, CharSequence input) {
                                    ...
                                    if (c.getCount() != 0) {
                                        Toast.makeText(MyStocksActivity.this, R.string.already_saved,Toast.LENGTH_LONG).show();
                                        return;
                                    } else {
                                        // Add the stock to DB
    ...
    private void networkToast() {
        Toast.makeText(MyStocksActivity.this,R.string.network_toast,Toast.LENGTH_SHORT).show();
    }
